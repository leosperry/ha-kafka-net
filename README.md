...
Version 3 pre-release has been merged. Use with caution. If you run into issues reset to an earlier tag. More automated tests and documentation still needed before release.
***
